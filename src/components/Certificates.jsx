...
const CertificateCard = ({ cert, aosDelay }) => {
  // Cards with a scanned certificate open it in a new tab; the rest stay static.
  ...
  return (
    <Wrapper
      ...
      className={`block bg-black/20 backdrop-blur-sm rounded-2xl p-5 border border-white/10 hover:border-white/25 hover:scale-105 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] transition-all duration-500 group ${
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0">
          ...
          {cert.file && (
            <span className="inline-flex items-center gap-1 mt-2 text-[10px] font-black uppercase tracking-widest text-white/40 group-hover:text-white transition-colors">
              View Certificate
