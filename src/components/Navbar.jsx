    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="flex items-center">
          <a href="#" className="text-white text-2xl md:text-lg lg:text-2xl font-black tracking-tight whitespace-nowrap">
        ...
        <div className="hidden md:flex md:space-x-5 lg:space-x-8">
          {navLinks.map((link) => (
            <a 
              ...
              className="text-white/80 hover:text-white font-medium text-sm lg:text-base whitespace-nowrap relative group transition-colors duration-300"
            >
              {link}
        ...
        <div className="hidden md:block">
          <a 
            href={hireMeMailto}
            className="px-4 py-2 text-sm lg:px-6 lg:py-2.5 lg:text-base whitespace-nowrap rounded-full bg-white/10 border border-white/20 text-white font-semibold hover:bg-white/20 hover:shadow-[0_0_15px_rgba(255,255,255,0.2)] transition-all duration-300 backdrop-blur-md"
          >
            Hire Me
          </a>
        </div>
